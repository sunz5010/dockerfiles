...
# export GIT_PULL_FOLDER=weixin
# export GIT_PULL_REPO=ssh://git-codecommit.us-east-1.amazonaws.com/v1/repos/weixin
# export SSH_HOST=git-codecommit.us-east-1.amazonaws.com
# export SSH_USER=APKAIKX6LK3ESWOIZBDA
# export SSH_IDENTITYFILE_PATH=/home/ubuntu/fofo_aws_codeCommit
